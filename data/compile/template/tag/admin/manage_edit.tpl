...
<body style="width:450px" class="body_none">
	<form class="J_ajaxForm" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','admin.php?_json=1&m=tag&c=manage&a=doedit'; ?>" method="post">
	...
	<div style="padding:0 0 15px 15px;">
		...
		<table width="100%">
			<tr>
				<th>话题名称</th>
				<td><span class="must_red">*</span><input type="text" name="tag[name]" value="<?php echo htmlspecialchars($tag['tag_name'], ENT_QUOTES, 'UTF-8');?>" class="input length_5 input_hd"></td>
			</tr>
			<tr>
				<th>话题图片</th>
				<td>
