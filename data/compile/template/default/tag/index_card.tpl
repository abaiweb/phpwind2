...
<div class="ft">
	关注后，最新的话题内容将显示在<a class="J_qlogin_trigger" data-referer="true" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=tag&a=my'; ?>">我的话题</a>中
</div>
<?php  } ?>