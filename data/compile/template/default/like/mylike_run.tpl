...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb">
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=like'; ?>">喜欢</a><em>&gt;</em><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike'; ?>">我的喜欢</a>
		</div>
		<div class="like_nav">
			<ul class="cc">
				<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=like'; ?>">热门喜欢</a></li>
				<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=ta'; ?>" data-referer="true" class="J_qlogin_trigger">Ta的喜欢</a></li>
				<li class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike'; ?>" data-referer="true" class="J_qlogin_trigger">我的喜欢</a></li>
			</ul>
		</div>
		<div class="main cc">
			<div class="main_body">
				<div class="main_content">
					...
					<?php  if ($logLists){ ?>
						<div class="like_content">
							...
							?>
								<dl class="cc">
								 <dt class="face"><img class="J_avatar" src="<?php echo htmlspecialchars(Pw::getAvatar(0, 'small'), ENT_QUOTES, 'UTF-8');?>" data-type="small" width="50" height="50" alt="游客" /></dt>
									<dd class="text_content">
										<div class="content">原文不存在</div>
										<div class="info">
											<span class="time">喜欢于<?php echo htmlspecialchars(Pw::time2str($logList['created_time']), ENT_QUOTES, 'UTF-8');?></span><a href="#" data-uri="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doDelLike'; ?>" data-pdata="{'logid':'<?php echo htmlspecialchars($logList['logid'], ENT_QUOTES, 'UTF-8');?>'}" class="a_unlike J_unlike">取消喜欢</a>
										</div>
									</dd>
								</dl>
							 <?php  continue; } ?>
								<dl class="cc">
								 <dt class="face"><a class="J_user_card_show" data-uid="<?php echo htmlspecialchars($uid, ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=space&uid=', rawurlencode($uid); ?>"><img  class="J_avatar" src="<?php echo htmlspecialchars(Pw::getAvatar($likeInfos[$logList['likeid']]['uid'], 'small'), ENT_QUOTES, 'UTF-8');?>" data-type="small" width="50" height="50" alt="<?php echo htmlspecialchars($likeInfos[$logList['likeid']]['username'], ENT_QUOTES, 'UTF-8');?>" /></a></dt>
									<dd class="text_content">
									<?php  if (empty($likeInfos[$logList['likeid']]['subject'])){?>
										...
										<div class="info">
											...
											<span class="time">喜欢于<?php echo htmlspecialchars(Pw::time2str($logList['created_time']), ENT_QUOTES, 'UTF-8');?></span><a href="#" data-uri="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doDelLike&logid=', rawurlencode($logList['logid']); ?>" data-pdata="{'logid':'<?php echo htmlspecialchars($logList['logid'], ENT_QUOTES, 'UTF-8');?>'}" class="a_unlike J_unlike">取消喜欢</a>
										</div>
									<?php  }else{ ?>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&page=', rawurlencode($_page_i); 
...
<?php  }} ?>
  ...
  foreach ($tagLists as $tag){ ?>
							<li id="J_side_group_<?php echo htmlspecialchars($tag['tagid'], ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doDelTag'; ?>" class="icon_del J_group_del" data-pdata="{'tag': '<?php echo htmlspecialchars($tag['tagid'], ENT_QUOTES, 'UTF-8');?>'}" data-id="<?php echo htmlspecialchars($tag['tagid'], ENT_QUOTES, 'UTF-8');?>">删除</a><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doEditTag&tag=', rawurlencode($tag['tagid']); ?>" data-name="<?php echo htmlspecialchars($tag['tagname'], ENT_QUOTES, 'UTF-8');?>" data-id="<?php echo htmlspecialchars($tag['tagid'], ENT_QUOTES, 'UTF-8');?>" class="icon_edit J_group_edit">编辑</a><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&tag=', rawurlencode($tag['tagid']); ?>" class="title"><span class="J_name"><?php echo htmlspecialchars($tag['tagname'], ENT_QUOTES, 'UTF-8');?></span><em>(<?php echo htmlspecialchars($tag['number'], ENT_QUOTES, 'UTF-8');?>)</em></a></li>
							<?php  } 
  } ?>
						</ul>
				...
				<div class="box_wrap">
					...
					<div class="like_hot_list">
						...
						<?php  foreach ($hotBrand as $list){ ?>
							<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','read.php?tid=', rawurlencode($list['fromid']); ?>"><?php echo htmlspecialchars($list['subject'], ENT_QUOTES, 'UTF-8');?></a><span class="num"><?php echo htmlspecialchars($list['counts'], ENT_QUOTES, 'UTF-8');?></span></li>         
						<?php  } ?>
						</ul>
					</div>
				</div>
	...
	<div id="J_tag_pop" class="core_pop_wrap" style="display:none;">
		<div class="core_pop">
			<div class="pop_like_sort">
				<form id="J_tag_form" method="post" action="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doAddTag'; ?>">
...
<script>
var  GRROUP_DATA = '<?php echo WindSecurity::escapeEncodeJson($likeJson, 'UTF-8');?>';
Wind.use('jquery', 'global', function(){
	...
	$('#J_group_check_ul').data({
		'saveList' : function(elem, type, id){
			...
			$.post("<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doLogTag'; ?>", {
				logid : elem.data('id'),
				tagid : id,
				type : (type ? 1 : 0)
			}, function(data){
		...
		'saveCreat' : function(btn){
			...
			$.post("<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doAddLogTag'; ?>", {
				...
				if(data.state === 'success') {
					...
					//右侧栏写入新分组
					my_like.append('<li id="J_side_group_'+ _data.id +'"><a class="icon_del J_group_del" data-pdata="{\'tag\': \''+ _data.id +'\'}" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doDelTag'; ?>" data-id="'+ _data.id +'">删除</a><a class="icon_edit J_group_edit" data-id="'+ _data.id +'" data-name="'+ _data.name +'" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doEditTag'; ?>&tag='+ _data.id +'">编辑</a><a class="title" href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike'; ?>&tag='+ _data.id +'"><span class="J_name">'+ _data.name +'</span><em>(1)</em></a></li>');
	...
	my_like.data({
		...
		creatsave :  '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doAddTag'; ?>',
		editsave : '<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=doEditTag'; ?>',
