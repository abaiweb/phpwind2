		...
		<div class="like_page_ta cc">
			<div class="like_nav cc">
				<ul>
					...
					<li  class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=ta'; ?>" data-referer="true" class="J_qlogin_trigger">Ta的喜欢</a></li>
					<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike'; ?>" data-referer="true" class="J_qlogin_trigger">我的喜欢</a></li>
				</ul>
			</div>
...
<script>
var J_LIKE_URL = "<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=like&c=mylike&a=data'; ?>";
