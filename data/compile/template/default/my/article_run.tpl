				...
				<div class="main_content">
					...
					<nav>
						<div class="content_nav">
							<ul>
								<li class="current"><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=my&c=article'; ?>">我的主题</a></li>
								<li><a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=my&c=article&a=reply'; ?>">我的回复</a></li>
							</ul>
						</div>
					</nav>
								...
								<tr>
									<td class="subject">
										<p class="title">
											...
											<?php if($value['topic_type']){?>
											<em class="s4">[<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?c=thread&fid=', rawurlencode($value['fid']),'&type=', rawurlencode($value['topic_type']); ?>" class="s4" target="_blank"><?php echo $topictypes[$value['topic_type']]['name'];?></a>]</em>
											<?php }?>
...
?>
	<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/','index.php?m=my&c=article&page=', rawurlencode($_page_i); 
